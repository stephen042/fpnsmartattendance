        ...
        <flux:sidebar.nav>
            <flux:sidebar.group :heading="__('Platform')" class="grid">
                <flux:sidebar.item icon="home" :href="route('lecturer.dashboard')"
                    :current="request()->routeIs('lecturer.dashboard')" wire:navigate>
                    {{ __('Dashboard') }}
                </flux:sidebar.item>
                <flux:sidebar.item icon="clipboard-document-check" :href="route('lecturer.logs')"
                    :current="request()->routeIs('lecturer.logs')" wire:navigate>
                    {{ __('Attendance Logs') }}
                </flux:sidebar.item>
            </flux:sidebar.group>
        </flux:sidebar.nav>
